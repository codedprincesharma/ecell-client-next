...
const EventMeta = ({ event, formatDate }) => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10 p-6 bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl hover:border-blue-500/20 transition-colors duration-300">
